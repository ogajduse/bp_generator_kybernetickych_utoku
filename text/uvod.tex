...
První část popisuje \zk{zk_dos} útoky, přiblížím jejich typy, původ a fungování. Následně je popsána struktura nástroje DoSgen a jsou popsány implementované útoky.