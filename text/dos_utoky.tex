...
zaplavove a pomale
rychle oznaceni "flood" velky pocet paketu za sek, vetsi sirka pasma
pomale se jevi byti legitimni, nezabiraji velkou sirku pasma

\subsection{Podle spoje}
Při tomto dělení můžeme útoky rozdělit na spojované a nespojované.
%spojované(ovlivni aplikace) a nespojované connectionless(ovlivni vetsinou serverove zdroje) a connection-oriented
